...
$message .= "http://localhost/Online%20Notes%20Application/resetpassword.php?user_id=$user_id&key=$key";

//             <!-- If email sent successfully -->
//                 <!-- print success message  -->
if(mail($email, 'Reset your password', $message, 'From:'.'vijayvasudevborge1@gmail.com')){
