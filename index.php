...
<html lang="en">
  ...
  <body>
    ...
    <form method="post" id="loginform">
      <div class="modal" id='loginModal' role="dialog" aria-labelledby="myModalLable" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Login message from PHP file -->
              ...
              <div class="checkbox">
                <lable style="margin-left: 20px"><input type="checkbox" name="rememberme" id="rememberme">Remember me</lable>
                <a class="pull-right" style="cursor: pointer" href="#forgotpasswordModal" data-toggle="modal" data-dismiss="modal">Forgot Password?</a>
              </div>
            </div>
    ...
    <form method="post" id="signupform">
      <div class="modal" id='signupModal' role="dialog" aria-labelledby="myModalLable" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button class="close" data-dismiss="modal">&times;</button>
    ...
    <form method="post" id="forgotpasswordform">
      <div class="modal" id='forgotpasswordModal' role="dialog" aria-labelledby="myModalLable" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button class="close" data-dismiss="modal">&times;</button>
